  ...
  <body class="container">
    ...
    <div>
      <table class="table table-borderless">
        <thead>
          <tr>
            <th class="col-product text-dark fs-4  ">
              <h4 class="my-5">Sản phẩm</h4>
            </th>
            <th style="transform: translateX(-10%)" class="text-dark fs-4 ">
              <h4 class="my-5">Số lượng</h4>
            </th>
            <th class=" text-end text-dark fs-4  ">
              <h4 class="my-5">Tổng tiền</h4>
            </th>
          </tr>
        </thead>
        ...
        <tbody>
            ...
            <tr>
              <td class="col-product">
                <div class="cart-product d-flex gap-4">
                  <img src="<?= $img_path ?><?= $row['hinh'] ?>" alt="" width="20%" height="10%" />
          ...
          <tr class="">
            <td></td>
            <td colspan="2" class="text-end "><a href="../sanpham/shop.php" class="text-decoration-none">
                <h5 style="transform: translateY(50%);">
                  << Tiếp Tục Mua Hàng</h5>
              </a></td>
            <td colspan="" class="text-end">
              <a href="../thanhtoan/thanh_toan.php" class="text-decoration-none">
                <p style="background-color: #F1F397 ; width:220px" class="text-center fs-4 fw-bold p-2 rounded-4 text-dark "> THANH TOÁN </p>
              </a>
            </td>
          </tr>
        </tbody>
    ...
    <script>
      ...
      function handlePlus(number, id, size) {
        ...
        $.post("../giohang/shopping-cart-xuly.php", {
          id: id,
          size: size,
          amount: 1
        }, function(data) {
